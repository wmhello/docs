...
const generateSeo = (options, base, { page, site, locale, path, themeConfig }) => {
    ...
    const articleTags = Array.isArray(tags)
        ...
        : typeof tag === "string"
            ...
            : [];
    return {
        "og:url": utils_1.resolveUrl(base, path),
        "og:site_name": site.title || "",
        "og:title": page.title,
        "og:description": page.frontmatter.description || page.frontmatter.summary || "",
        "og:type": type,
        "og:image": image ? utils_1.resolveUrl(base, image) : "",
